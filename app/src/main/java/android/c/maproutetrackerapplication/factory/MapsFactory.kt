package android.c.maproutetrackerapplication.factory
...
import android.c.maproutetrackerapplication.utility.DisplayUtility
...
object MapsFactory
{
    ...
    {
        val drawable = context.resources.getDrawable(R.drawable.ic_location_end_black_24dp, context.theme)
        ...
        val paint = Paint()
        paint.textSize = 20 * context.resources.displayMetrics.density / 2
    ...
    fun drawRoute(context: Context): PolylineOptions {
        ...
        polylineOptions.width(DisplayUtility.px2dip(context, 10.toFloat()).toFloat())
